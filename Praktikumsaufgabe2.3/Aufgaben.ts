...
function getContainerPoint1(): Point { 
...
function createRect1(): void {
    ...
    let point1: Point = getContainerPoint1(); //Erzeugt zwei zufällige Punkte, innerhalb des Containers, mit denen das Rechteck erzeugt wird
    let point2: Point = getContainerPoint1();
