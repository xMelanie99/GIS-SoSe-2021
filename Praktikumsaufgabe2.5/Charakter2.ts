namespace Charakter {
    ...
    enum StorageLocation { // Datentyp um die Ausgewähle Option später an der richtige Stelle speichern zu können
        SKIN = "skin",
        PATTERN = "pattern",
        HAT = "hat",
        PANTS = "pants"
    ...
    interface Page { // enthält alle Infos der einzelnen Seite
        title: string;
    ...
    async function comuBrows(_url: RequestInfo): Promise<void> {
    ...
    function allDataSelect(): void {
        ...
        function showGeneralView(): void {
            ...
            function showFinalResult(): void {
                ...
                let uploadButton: HTMLButtonElement = <HTMLButtonElement>document.createElement("button");
